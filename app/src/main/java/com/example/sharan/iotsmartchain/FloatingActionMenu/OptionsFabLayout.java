package com.example.sharan.iotsmartchain.FloatingActionMenu;
...
public class OptionsFabLayout extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        LayoutParams params = (LayoutParams) mFabWithOptions.getLayoutParams();
    ...
    public void setMiniFabSelectedListener(final OnMiniFabSelectedListener listener) {
        for (int miniFabIndex = 0; miniFabIndex < mFabWithOptions.getMiniFabs().size(); miniFabIndex++) {
            ...
            mFabWithOptions.getMiniFabs().get(miniFabIndex).getCard().setOnClickListener(new OnClickListener() {
