...
public class NewProfileFragment extends BaseFragment {
    ...
    private static String TAG = NewProfileFragment.class.getSimpleName();
    ...
    private TextView mTextPhoneNum, mTextFullName;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mTextFullName = rootView.findViewById(R.id.textview_name_val);
        mTextPhoneNum = rootView.findViewById(R.id.textview_phone_num);
        ...
        try {
            ...
            if (userPhone != null) {
                mTextViewPhone.setText(userPhone);
                mTextPhoneNum.setText(userPhone);
            }
            if (userName != null) {
                mTvLoginName.setText(userName);
                mTextFullName.setText(userName);
            }
        ...
        mProfileEditIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(v.getContext(), "Not yet design!!!", Toast.LENGTH_SHORT).show();
                // show dialog for editing name and change phone number
                updateProfileInfo(userName, "", userPhone);
            }
        });
        /*Logout app*/
    ...
    private void AppLogout() {
        ...
        appLogOutAsync = new AppLogOutAsync(getActivity(), loginId);
    ...
    /*Edit profile name and change phone number*/
    private void updateProfileInfo(String fName, String lName, String phone) {
        dialog = new Dialog(getActivity());
        builder = new AlertDialog.Builder(getActivity());
        LayoutInflater layoutInflater = getActivity().getLayoutInflater();
        View rootView = layoutInflater.inflate(R.layout.dialog_update_profile_info, null);
        EditText editTextFname = (EditText) rootView.findViewById(R.id.edittext_first_name);
        EditText editTextLname = (EditText) rootView.findViewById(R.id.edittext_last_name);
        EditText editTextPhone = (EditText) rootView.findViewById(R.id.edittext_phone);
        ...
        builder.setPositiveButton("Done", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!TextUtils.isEmpty(fName) && !(TextUtils.isEmpty(lname) && !(TextUtils.isEmpty(phone)))) {
                    ...
                    Toast.makeText(getContext(), "Should't be empty!!!", Toast.LENGTH_SHORT).show();
                }
