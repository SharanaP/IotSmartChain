...
import static com.example.sharan.iotsmartchain.vi.filepicker.MainActivity.RC_FILE_PICKER_PERM;
import static com.example.sharan.iotsmartchain.vi.filepicker.MainActivity.RC_PHOTO_PICKER_PERM;
    ...
    public void pickPhoto() {
        if (EasyPermissions.hasPermissions(getContext(), FilePickerConst.PERMISSIONS_FILE_PICKER)) {
            ...
            EasyPermissions.requestPermissions(
                    this, getString(R.string.rationale_photo_picker),
